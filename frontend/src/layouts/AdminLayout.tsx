...
function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: "Brokers", path: "/admin/brokers", icon: <Users size={18} /> },
    { name: "Policy Review", path: "/admin/review-policies", icon: <ShieldCheck size={18} /> },
    { name: "Metadata", path: "/admin/metadata", icon: <Database size={18} /> },
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden text-slate-900">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[10px] uppercase tracking-widest text-teal-400">Admin</span>
            </div>
          </div>
          <button
            onClick={() => setIsOpen(false)}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200/80">
          ...
          <span className="text-sm font-semibold text-slate-900">InsurePro Admin</span>
          <div className="w-8" />
        </header>
