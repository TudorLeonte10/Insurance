...
{
    public class CreateRiskFactorConfigurationDtoValidator : AbstractValidator<CreateRiskFactorConfigurationDto>
    {
        public CreateRiskFactorConfigurationDtoValidator()
        {
